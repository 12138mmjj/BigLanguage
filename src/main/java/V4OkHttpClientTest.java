...
public class V4OkHttpClientTest {
    ...
    private static final String API_KEY = "f343c7e20190c3f2c03a7e03c4c8f1b8";
 
    private static final String API_SECRET = "MK2vfE38Frbuvihp";
...
//        createImageRequest.setPrompt("画一个温顺可爱的小狗");
    ...
    private static void testSseInvoke() {
        List<ChatMessage> messages = new ArrayList<>();
        ChatMessage chatMessage = new ChatMessage(ChatMessageRole.USER.value(), "输出一个搜索算法");
